...
export default class Level1 {
    constructor() {
        ...
        this.enemies = {
            // wave 1
            150: [new Enemy(120, 0, 0, 4, 10, "single", "straight"),],
            160: [  new Enemy(120, 0, 0, 4, 10, "single", "straight"),],
            170: [new Enemy(120, 0, 0, 4, 10, "single", "straight"),],
            175: [new Enemy(400, -20, 0, 4, 10, "single", "straight"),],
            180: [  new Enemy(120, 0, 0, 4, 10, "single", "straight"),],
            185: [  new Enemy(400, -20, 0, 4, 10, "single", "straight"),],
            190: [new Enemy(120, 0, 0, 4, 30, "single", "straight"),],
            195: [new Enemy(400, -20, 0, 4, 10, "single", "straight"),],
            205: [  new Enemy(400, -20, 0, 4, 10, "single", "straight"),],
            215: [new Enemy(400, -20, 0, 4, 30, "single", "straight"),],
