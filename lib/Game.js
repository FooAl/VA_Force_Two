...
class Game{
    ...
    render(){
        ...
        if(this.gameOver[0] === false){
            this.game();
        }else if(this.gameOver[0] === true){
            this.fadeOut = 0;
            this.levelTimer++;
            startScreen(this.render.bind(this), this.ctx, this.spriteSheet, this.levelTimer, this.highScore);
        ...
        if(this.fadeIn > 0){
            fadeIn(this.ctx, this.fadeIn);
            this.fadeIn -= 0.01;
        }
        if(this.fadeOut !== 1){
            fadeOut(this.ctx, this.fadeOut);
            this.fadeOut += 0.01;
        }
    }

    reset(){
        this.levelTimer = 3400;
    ...
    game(){
            ...
            if(this.player.lives === 0 && this.gameOver[0] === false){
                this.fadeOut = 0;
                this.gameOver[0] = true;
                // setTimeout(function () { this.gameOver[0] = true;}, 400);
            }
