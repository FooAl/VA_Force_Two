...
export default class Enemy extends Entity{
    constructor(x,y,dx,dy, health, shotType = "single", moveType = "straight", points, pickups = "points"){
        super(x,y,dx,dy);
        this.height = 20;
        this.width = 20;
        this.health = health;
        ...
        if(this.destroyed === false && bullet.destroyed === false){
            ...
            if(this.health < 0){
                ...
                this.pickups.forEach(pickup => {
                    ...
                    pickups.push(new PowerUp(this.x, this.y, randX, randY, pickup));
                });
            }
        }
    }
    ...
    render(ctx, spriteSheet, enemyBulletArray, player){
        ...
        this.x += this.dx;
        this.y += this.dy;
        if(this.lifespan === 40 && player.protectTimer <= 0){
            shoot(this.shotType, enemyBulletArray, [this.x + 10, this.y + 10], 
